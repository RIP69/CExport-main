...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Kaushan+Script&family=Oswald:wght@300;500;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Plus+Jakarta+Sans:wght@300;400;600;800&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        /* Top state active (White) */
        .nav-link.active { color: #FFC300 !important; }
        .nav-link.active::after { width: 100%; background-color: #FFC300; }
...
<body class="bg-brand-light text-brand-navy font-sans antialiased overflow-x-hidden">
    ...
    <nav class="fixed w-full z-50 transition-all duration-300 border-b border-white/0" id="navbar">
            ...
            <div class="flex items-center justify-between h-20">
                <div class="flex items-center gap-2">
                    <img id="nav-logo" src="view_image.php?type=logo" alt="CExport Logo"
                        class="h-12 w-auto object-contain drop-shadow-md transition-all duration-300 brightness-0 invert">
                </div>

                <div class="hidden md:block">
                    <div class="ml-10 flex items-center space-x-8">
                        <a href="#home" class="nav-link text-white hover:text-brand-accent font-bold text-sm uppercase tracking-wide transition-colors drop-shadow-sm active">Home</a>
                        <a href="pages/about.php" class="nav-link text-white hover:text-brand-accent font-bold text-sm uppercase tracking-wide transition-colors drop-shadow-sm">About</a>
                        <a href="pages/gallery.php" class="nav-link text-white hover:text-brand-accent font-bold text-sm uppercase tracking-wide transition-colors drop-shadow-sm">Gallery</a>
                        <a href="pages/product.php" class="nav-link text-white hover:text-brand-accent font-bold text-sm uppercase tracking-wide transition-colors drop-shadow-sm">Product</a>
                        <a href="pages/service.php" class="nav-link text-white hover:text-brand-accent font-bold text-sm uppercase tracking-wide transition-colors drop-shadow-sm">Services</a>
        ...
        <div class="md:hidden hidden bg-brand-navy/95 backdrop-blur-xl absolute w-full border-b border-white/20 shadow-xl" id="mobile-menu">
            <div class="px-4 pt-4 pb-6 space-y-2">
                <a href="#home" class="nav-link block px-3 py-3 rounded-md text-white font-bold hover:bg-white/10 transition-colors">Home</a>
                <a href="pages/about.php" class="nav-link block px-3 py-3 rounded-md text-white font-bold hover:bg-white/10 transition-colors">About</a>
                <a href="#personal-journey" class="nav-link block px-3 py-3 rounded-md text-white font-bold hover:bg-white/10 transition-colors">Gallery</a>
                <a href="#gallery" class="nav-link block px-3 py-3 rounded-md text-white font-bold hover:bg-white/10 transition-colors">Product</a>
                <a href="#services" class="nav-link block px-3 py-3 rounded-md text-white font-bold hover:bg-white/10 transition-colors">Services</a>
    ...
    <header id="home" class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center h-full">
            <div class="pt-20 md:pt-0" data-aos="fade-right" data-aos-duration="1000">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#collection"
                        class="px-8 py-4 bg-brand-accent text-brand-navy font-bold uppercase tracking-wider hover:bg-white hover:text-brand-blue transition-all shadow-lg shadow-brand-accent/20 flex items-center gap-2 group rounded-full transform hover:-translate-y-1">
                        View Catalog <i data-lucide="arrow-right"
                            class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                    </a>
                    <a href="#contact"
                        class="px-8 py-4 border-2 border-white/30 text-white font-bold uppercase tracking-wider hover:bg-white hover:text-brand-navy hover:border-white transition-all rounded-full backdrop-blur-sm">
                        Start Order
                    </a>
                </div>
            </div>
            ...
            <div class="hidden md:block relative h-full pointer-events-none">
                <div class="absolute top-1/3 right-10 glass-water p-3 rounded-2xl shadow-2xl animate-float z-20 border-t border-white/50"
        ...
        <div class="absolute bottom-10 right-10 z-30 animate-fadeIn">
            <button id="audioToggle"
                class="p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white hover:bg-white/20 hover:scale-110 transition-all duration-300 shadow-xl group">
    ...
    <section class="bg-brand-blue py-16 relative overflow-hidden">
        ...
        <div class="absolute bottom-10 right-10 w-32 h-32 bg-white/10 rounded-full blur-xl animate-float"
    ...
    <section class="py-20 bg-white relative">
        ...
        <div class="relative max-w-7xl mx-auto px-6 group">
            <div
                class="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-white to-transparent z-10 pointer-events-none">
            </div>
            <div
                class="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-white to-transparent z-10 pointer-events-none">
            </div>
                ...
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide text-center flex flex-col items-center">
                        <img src="view_image.php?type=network&id=<?= $country['id'] ?>"
                            class="w-20 h-20 rounded-full object-cover border-4 border-gray-100 shadow-lg mx-auto mb-4"
                            alt="<?= htmlspecialchars($country['country_name']) ?>">
                        <h4 class="text-lg font-heading font-bold text-gray-400 uppercase tracking-widest">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative" data-aos="fade-right">
                    ...
                    <div
                        class="swiper aboutSwiper   overflow-hidden shadow-2xl relative z-10 h-[750px] w-full max-w-md mx-auto aspect-[4/5] bg-white">
                        <div class="swiper-wrapper h-full">
                            <?php 
                            $slides = $pdo->query("SELECT id FROM about_carousel ORDER BY id ASC")->fetchAll();
                            if(empty($slides)): ?>
                            <div class="swiper-slide h-full w-full">
                                <img src="https://via.placeholder.com/600x900?text=Upload+Images+in+Admin"
                                    class="w-full h-full ">
                            </div>
    ...
    <section id="services" class="py-24 bg-white overflow-hidden relative">
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative" data-aos="fade-right">
                    <div class="absolute -top-10 -left-10 w-40 h-40 bg-brand-accent rounded-full opacity-20 blur-2xl">
                    </div>
                    <div
                        class="relative z-10 rounded-[4rem] rounded-tl-none overflow-hidden shadow-2xl border-8 border-brand-light animate-water bg-white">
                        <img src="view_image.php?type=content&key=services_img"
                            class="w-full h-full object-cover scale-110 hover:scale-100 transition-transform duration-1000">
                    </div>

                    <div
                        class="absolute -bottom-6 -right-6 bg-brand-blue text-white p-8 rounded-full shadow-xl shadow-brand-blue/30 z-20 w-32 h-32 flex flex-col items-center justify-center border-4 border-white">
                        <p class="font-heading font-bold text-3xl mb-0">
                            <?= getContent('services_badge_val') ?>
                        </p>
                        <p class="text-[0.6rem] uppercase tracking-widest text-brand-light">
                            <?= getContent('services_badge_label') ?>
                        </p>
                    </div>
                </div>
                ...
                <div data-aos="fade-left">
                    <h4
                        class="text-brand-blue font-bold tracking-[0.2em] uppercase text-sm mb-4 flex items-center gap-2">
                        <span class="w-8 h-0.5 bg-brand-blue"></span>
                        <?= getContent('services_subtitle') ?>
                    </h4>
                    ...
                    <div class="space-y-6">
                        <div
                            class="flex items-start gap-4 p-6 rounded-2xl border border-brand-light hover:bg-brand-light/50 transition-colors group shadow-sm hover:shadow-md">
                            <div
                                class="w-12 h-12 bg-white border border-brand-light shadow-md rounded-full flex items-center justify-center text-brand-accent group-hover:bg-brand-blue group-hover:text-white transition-colors shrink-0">
                                <i data-lucide="briefcase" class="w-6 h-6"></i>
                            </div>
                            <div>
                                <h3 class="font-bold text-brand-navy text-xl">
                                    <?= getContent('service_1_title') ?>
                                </h3>
                                <div class="text-sm text-gray-500 mt-2">
                                    <?= getContent('service_1_desc') ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                <h3 class="font-bold text-brand-navy text-xl">
                                    <?= getContent('service_2_title') ?>
                                </h3>
                                <div class="text-sm text-gray-500 mt-2">
                                    <?= getContent('service_2_desc') ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                <h3 class="font-bold text-brand-navy text-xl">
                                    <?= getContent('service_3_title') ?>
                                </h3>
                                <div class="text-sm text-gray-500 mt-2">
                                    <?= getContent('service_3_desc') ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function filterGallery(type) {
            ...
            buttons.forEach(b => {
                ...
                if (b.textContent.toLowerCase() === type || (type === 'all' && b.textContent === 'All')) {
                    ...
                    b.classList.remove('text-white-500');
                }
            });
